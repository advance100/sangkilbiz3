...
namespace core\accounting\hooks;

use Yii;
use core\base\Event;
use core\accounting\components\GL as ApiGL;
...
class GL extends \yii\base\Behavior
{
    ...
    {
        /* @var $model \core\accounting\models\Invoice */
    ...
    {
        /* @var $model \core\accounting\models\Payment */
        $model = $event->params[0];
        $value = 0;
